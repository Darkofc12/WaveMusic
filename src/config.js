...
module.exports = {
  token: process.env.TOKEN || 'MTE5Mjg0NDgyMjU3OTUzMTkyOA.GO1M8z.Aapthm25l1uO2QomIqtMaVQ3qoDMTblVi432ig', // your discord bot token
  ...
  links: {
    ...
    invite: process.env.INVITE || 'https://discord.com/api/oauth2/authorize?client_id=1192840963920511158&permissions=0&scope=bot+applications.commands',
